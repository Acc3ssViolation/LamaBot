...
namespace LamaBot.Migrations
{
    ...
    [Migration("20260909201358_UserCommands")]
    partial class UserCommands
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LamaBot.Database.DbApiKey", b =>
                {
            ...
            modelBuilder.Entity("LamaBot.Database.DbQuoteRequest", b =>
                {
                    b.Property<ulong>("GuildId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("GuildId", "Id", "TimestampUtc");
            ...
            modelBuilder.Entity("LamaBot.Database.DbUserCommand", b =>
                {
                    b.Property<ulong>("GuildId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LamaBot.Database.DbQuoteRequest", b =>
                {
                    b.HasOne("LamaBot.Database.DbQuote", "Quote")
                        .WithMany("Requests")
